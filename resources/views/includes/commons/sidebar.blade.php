<div class="app-sidebar">
    <nav>
        ...
        <ul class="app-sidebar-menu">
            ...
            {{-- Closing Hours --}}
            <li>
                <a href="{{ route('admin.closing-hours.index') }}"
                    class="@if (Route::is('admin.closing-hours*')) active @endif">
                    <i class="fas fa-clock fa-xl fa-fw"></i>
                    <span class="d-none d-md-inline">{{ __('common.closing_hours') }}</span>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('admin.blacklist.index') }}" class="@if (Route::is('admin.blacklist*')) active @endif">
                    <i class="fas fa-skull fa-xl fa-fw"></i>
