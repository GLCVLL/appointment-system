            ...
            <table class="table table-hover align-middle">
                <thead>
                    <tr>
                        ...
                        <th scope="col" class="d-none d-sm-table-cell text-center">{{ __('users.missed_count') }}</th>
                        <th scope="col"></th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="d-none d-sm-table-cell text-center">{{ $user->missed_appointments_count }}</td>
                        <td>
                            {{-- Actions --}}
