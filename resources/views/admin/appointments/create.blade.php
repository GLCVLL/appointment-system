...
@section('title', ' - ' . __('appointments.add'))
    ...
    <div class="container-fluid">
        ...
        <header class="mb-4">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                {{-- Title --}}
                <h2 class="mb-0">{{ __('appointments.add') }}</h2>
...
<script>
    ...
    // Get Current Times
    const currentStartTime = @json(old('start_time', $appointment->exists ? $appointment->getDate('start_time', 'H:i') : ''));
